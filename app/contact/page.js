        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-4">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-sm">
              ...
              <p className="mt-1 text-sm text-slate-600">We reply within 1–2 business days for Standard users.</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-sm">
          ...
          <div className="rounded-3xl bg-slate-900 p-6 text-white shadow-lg">
            <p className="text-xs uppercase tracking-[0.35em] text-sky-200">Need priority support?</p>
            <p className="mt-2 text-sm text-slate-200">
              Premium accounts get faster responses, dedicated onboarding, and workflow reviews.
            </p>
            <Link
              href="/premium"
