        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 relative">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-2xl md:text-3xl font-[var(--font-display)] text-slate-900">
                The best free online PDF tools — built for speed, privacy, and clarity.
              </h2>
            </div>
            <p className="text-sm md:text-base text-[color:var(--muted)] max-w-md">
              Compress PDF, convert PDF to Word or Excel, and download videos — all free and unlimited.
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="relative overflow-hidden rounded-2xl border border-white/60 bg-white/80 p-6 shadow-sm backdrop-blur">
              ...
              <h3 className="mt-3 text-lg font-semibold text-slate-900">Secure PDF processing</h3>
              <p className="mt-2 text-sm text-[color:var(--muted)]">
                Compress and convert PDF files securely. Runs in your browser where possible — your files stay with you.
              </p>
            </div>
            <div className="relative overflow-hidden rounded-2xl border border-white/60 bg-white/80 p-6 shadow-sm backdrop-blur">
              <div aria-hidden className="absolute -bottom-10 -left-8 h-24 w-24 rounded-full bg-teal-100 blur-2xl" />
              <div className="text-2xl">⚡️</div>
              <h3 className="mt-3 text-lg font-semibold text-slate-900">Fast PDF converter online</h3>
              <p className="mt-2 text-sm text-[color:var(--muted)]">
                Convert PDF to Word, Excel, or JPG in seconds with clean, simple workflows.
              </p>
            </div>
            <div className="relative overflow-hidden rounded-2xl border border-white/60 bg-white/80 p-6 shadow-sm backdrop-blur">
              <div aria-hidden className="absolute -top-6 -left-6 h-16 w-16 rounded-full bg-rose-100 blur-2xl" />
              <div className="text-2xl">💸</div>
              <h3 className="mt-3 text-lg font-semibold text-slate-900">Free PDF tools — no watermark</h3>
              <p className="mt-2 text-sm text-[color:var(--muted)]">
                Use the best online PDF compressor, converter, and video downloader at no cost. No watermark added!
              </p>
            </div>
          </div>
        </div>
